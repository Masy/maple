...
maple::widgets::Window::Window(const std::string_view &title, uint32_t style) {
	LONG dwStyle = 0;
	LONG exStyle = 0;
...
void maple::widgets::Window::setVisible(const bool visible) {
...
//			SetWindowPos(m_windowHandle, nullptr, 0, 0, 0, 0, SWP_NOMOVE | SWP_NOSIZE | SWP_HIDEWINDOW | SWP_NOACTIVATE);
//			PostMessage(m_windowHandle, WM_SHOWWINDOW, FALSE, 0);
		}
	}
}
